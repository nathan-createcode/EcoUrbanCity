...
$sql = "SELECT * FROM laporan_infrastruktur WHERE
        kategori = 'lingkungan' AND role = 'lingkungan' AND
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="lingkungan_delete_report.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus laporan ini?')">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="4">Tidak ada laporan infrastruktur lingkungan.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
