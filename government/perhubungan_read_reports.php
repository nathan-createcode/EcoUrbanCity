...
<head>
    ...
    <title>Laporan Infrastruktur Perhubungan - EcoUrbanCity</title>
...
<body>
    <div class="dashboard">
        ...
        <main class="main-content">
            <div class="container">
                <div class="header">
                    <h2><i class="fas fa-file-alt"></i> Laporan Infrastruktur Perhubungan</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="photo-cell">
                                            <?php if ($row['photo'] && file_exists("../perhubungan_reports_img/" . $row['photo'])): ?>
                                                <img src="../perhubungan_reports_img/<?php echo htmlspecialchars($row['photo']); ?>"
                                                    alt="Foto Laporan"
                                                    class="report-image"
                                        ...
                                        <td>
                                            <a href="perhubungan_delete_report.php?id=<?php echo $row['id']; ?>"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5">Tidak ada laporan infrastruktur perhubungan.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
