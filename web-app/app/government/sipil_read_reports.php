                            ...
                            <?php if ($result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="photo-cell">
                                            <?php if ($row['photo'] && file_exists("../sipil_reports_img/" . $row['photo'])): ?>
                                                <img src="../sipil_reports_img/<?php echo htmlspecialchars($row['photo']); ?>"
                                                    alt="Foto Laporan"
                                                    class="report-image"
                                        ...
                                        <td>
                                            <a href="sipil_delete_report.php?id=<?php echo $row['id']; ?>"
